...
helpdeskkit is a robust starter kit built on Laravel 12.x and Filament 4.x, designed to accelerate the development of modern
...
```bash
helpdeskkit new my-app --kit=jeffersongoncalves/helpdeskkitv4
```
