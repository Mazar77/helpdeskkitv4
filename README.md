...
![FilaKit](https://raw.githubusercontent.com/jeffersongoncalves/filakitv4/main/art/jeffersongoncalves-filakitv4.png)
...
```bash
filakit new my-app --kit=jeffersongoncalves/filakitv4
```
